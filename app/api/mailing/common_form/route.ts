...
export async function POST(request: NextRequest) {
  try {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #dc2626; border-bottom: 2px solid #dc2626; padding-bottom: 10px;">
            Nuevo mensaje de contacto - Bunader
          </h2>
          ...
          <div style="margin-top: 20px; padding: 15px; background-color: #fef2f2; border-left: 4px solid #dc2626; border-radius: 4px;">
            <p style="margin: 0; color: #991b1b; font-size: 14px;">
              Este mensaje fue enviado desde el formulario de contacto de la página web de Bunader.
            </p>
          </div>
        </div>
      `,
    ...
    if (error) {
      console.error('Error sending email to Bunader:', error);
      return NextResponse.json(
    ...
    const { error: confirmationError } = await resend.emails.send({
      from: 'Bunader Negocios Inmobiliarios <no-reply@email.bunader.com.ar>',
      to: [email],
      subject: `Confirmación de mensaje recibido - ${subject}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #dc2626; border-bottom: 2px solid #dc2626; padding-bottom: 10px;">
            ¡Mensaje recibido! - Bunader
          </h2>
          ...
          <div style="background-color: #f9fafb; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h3 style="color: #374151; margin-top: 0;">Resumen de tu mensaje:</h3>
            <p><strong>Asunto:</strong> ${subject}</p>
          ...
          <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; font-size: 14px; margin: 0;">
              Gracias por contactar con <strong>Bunader Negocios Inmobiliarios</strong><br>
