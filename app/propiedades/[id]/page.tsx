                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8 text-center">
                                    ...
                                    {property.bedrooms !== undefined && property.bedrooms > 0 && (
                                        <div className="flex flex-col items-center p-4">
                                            ...
                                            <span className="text-sm text-gray-500">dormitorio{property.bedrooms > 1 ? 's' : ''}</span>
                                        </div>
                                    )}
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                                            {property.bedrooms !== undefined && property.bedrooms > 0 && (
                                                <div className="flex justify-between">
                                                    <span className="text-gray-600">Dormitorio:</span>
                                ...
                                {property.tags && property.tags.filter((tag) => tag.type === 2).length > 0 && (
                                    <div className="mb-8">
                                        <h2 className="text-2xl font-bold mb-6">Dormitorios</h2>
